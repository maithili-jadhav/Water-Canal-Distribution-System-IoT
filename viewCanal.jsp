...
<style>
body {
    background-image: url('../images/Canal_Water_Distribution_New.jpg');
...
<tr>
					...
					<th align="center">Action</th>
                                          ...
                                          <tbody>
                                                   ...
                                                   <td><a href="removeCanal.jsp?id=<%=resultSet.getString("cid") %>" onclick="return confirm_alert(this);">Delete</a></td>
