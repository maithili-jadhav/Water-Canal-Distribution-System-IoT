           ...
           <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          <tbody>
                                                   ...
                                                   <td><%=resultSet.getString("crops") %></td>
                                                   <td><%=resultSet.getString("cid") %></td>
                                                   <%-- <td><%=resultSet.getString("pid") %></td>
                                                   <td><%=resultSet.getString("leakage") %></td> --%>

                                                   <td><a href="removeFarmer.jsp?id=<%=resultSet.getString("aadhar") %>" onclick="return confirm_alert(this);">Delete</a></td>
