           ...
           <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          <tbody>
                                                   ...
                                                   <td><%=resultSet.getString("comp") %></td>

                                                   <td><a href="resolveFeedback.jsp?id=<%=resultSet.getString("mobile") %>" onclick="return confirm_alert(this);">Mark as Resolved & Delete</a></td>
