           ...
           <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          <tbody>
                                                   ...
                                                   <td><%=resultSet.getString("phours") %></td>

                                                   <td><a href="recharge.jsp?id=<%=resultSet.getString("pid") %>" onclick="return confirm_alert(this);">Recharge</a></td>
