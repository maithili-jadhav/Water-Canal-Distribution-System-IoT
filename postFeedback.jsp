...
font-size: 16px;"> &nbsp; <a href="index.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
      ...
      <div id="page-wrapper" >
        ...
        <form action="PostFeedback" method="post">
    			...
    			<label for="inputEmail3" class="col-sm-3 form-control-label">Feedback / Complaint</label>
                  <div class="col-sm-9">
                    <textarea cols="7" rows="5" class="form-control" name="feedback" placeholder="Enter your Feedback or Complaint" required></textarea>
                  </div>
                </div>
                
                <div class="form-group row m-b-0">
                  <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-primary">Post Feedback/Complaint</button>
                  </div>
                </div>
