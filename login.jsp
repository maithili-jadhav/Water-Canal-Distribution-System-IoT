...
<head>
    <title>Water Canal Distribution System</title>
    <!-- meta tags -->
    <meta charset="UTF-8" />
...
<body>
    ...
    <div class=" w3l-login-form">
        <h2 style="color:red; text-shadow: 0.5px 0.5px 0.5px black;">Farmer Login</h2>
        <form action="Login" method="POST">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" placeholder="Mobile" name="email" required="required" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10"/>
                </div>
            </div>
